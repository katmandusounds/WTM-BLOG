      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4 sm:gap-6 w-full justify-items-center">
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              <div
                className="relative bg-gray-900 rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform group-hover:-translate-y-1 w-full cursor-pointer"
              ...
              <div className="mt-3 px-1 space-y-1 w-full text-center">
                <Link
                  href={detailHref}
                  className="text-xs font-medium text-white group-hover:text-ifuno-green transition-colors duration-200 line-clamp-2 break-words title-stroke hover:underline"
                >
